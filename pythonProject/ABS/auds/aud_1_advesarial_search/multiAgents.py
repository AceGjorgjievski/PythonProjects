...
class MinimaxAgent(MultiAgentSearchAgent):
    ...
    def getAction(self, gameState):
        ...
        """
        "*** YOUR CODE HERE ***"
        return self.max_value(gameState, 0, 0)[1] # pacman sekogash prv kje prevzema akcija
    ...
    def value(self, gameState, agentIndex, depth):
        ...
        if agentIndex == 0:
            ...
            return self.min_value(gameState, agentIndex, depth)[0]
    ...
    def max_value(self, gameState, agentIndex, depth):
        ...
        for action in gameState.getLegalActions(agentIndex):
            ...
            v1 = self.value(successor_state, next_agent_index, depth + 1)
            if v1 > val:
                val = v1
                best_action = action
...
class AlphaBetaAgent(MultiAgentSearchAgent):
    ...
    def getAction(self, gameState):
        ...
        "*** YOUR CODE HERE ***"
        # util.raiseNotDefined()
        return self.max_value(gameState, 0, 0, float('inf'), float('-inf'))
