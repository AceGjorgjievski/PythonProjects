...
def get_data():
    return [['1', '35', '12', '5', '1', '100', '0'], ['1', '29', '7', '5', '1', '96', '1'],
...
if __name__ == '__main__':
    ...
    encoder.fit([row[:-1] for row in data_float])

    train_set = data_float[:int(0.85*len(data_float))]
    train_x = [row[:-1] for row in train_set]
    train_y = [row[-1] for row in train_set]


    test_set = data_float[int(0.85*len(data_float)):]
    ...
    print(int(predicted_entry_class))
    predicted_probabilities = classifier.predict_proba([entry])
