...
if __name__ == '__main__':
    ...
    for row in dataset:
        row_v2 = [float(col) for col in row]
        dataset_v2.append(row_v2)


    train_set = dataset_v2[:int(0.85*len(dataset_v2))]
    train_x = [row[:-1] for row in train_set]
    train_y = [row[-1] for row in train_set]

    test_set = dataset_v2[int(0.85*len(dataset_v2)):]
    ...
    predicted_entry = classifier.predict([entry])
    print(int(predicted_entry[0]))
